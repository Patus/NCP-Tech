...
makeRecipe{name="Nitrogen_dioxide",energy_required=1.5,category="Chemical_plant",ingredients={{type="item", name="Nitric_oxide", amount=2},{type="fluid", name="Oxygen", amount=1},},results={{type="fluid", name="Nitrogen_dioxide", amount=2,probability =1},},}
makeRecipe{name="Nitric_acid",energy_required=3,category="Chemical_plant",ingredients={{type="item", name="Potassium_nitrate", amount=2},{type="fluid", name="Sulfuric_acid", amount=1},},results={{type="fluid", name="Nitric_acid", amount=2,probability =1},{type="item", name="Potassium_sulfate", amount=1,probability =1},},}
makeRecipe{name="Uranium_tetrafluoride",energy_required=6,category="Chemical_plant",ingredients={{type="item", name="Uranium_dioxide", amount=1},{type="fluid", name="Hydrofluoric_acid", amount=4},},results={{type="fluid", name="Uranium_tetrafluoride", amount=1,probability =1},},}
...
makeRecipe{name="Hydrofluoric_acid",energy_required=1,category="Chemical_plant",ingredients={{type="fluid", name="Hydrogen_fluoride", amount=1},{type="fluid", name="Water_distilled", amount=1},},results={{type="fluid", name="Hydrofluoric_acid", amount=1,probability =1},},}
...
makeRecipe{name="Dichloroethane",energy_required=4,category="Chemical_plant",ingredients={{type="item", name="Hydrogen_chloride", amount=2},{type="fluid", name="Ethylene", amount=1},},results={{type="fluid", name="Dichloroethane", amount=1,probability =1},{type="fluid", name="Water", amount=1,probability =1},},}
makeRecipe{name="Hydrogen_chloride",energy_required=7,category="Chemical_plant",ingredients={{type="fluid", name="Dichloroethane", amount=2},},results={{type="fluid", name="Hydrogen_chloride", amount=1,probability =1},{type="item", name="Plastic_pellets", amount=1,probability =1},},}
...
makeRecipe{name="Diesel",energy_required=4,category="Chemical_plant",ingredients={{type="fluid", name="Light_oil", amount=1},},results={{type="fluid", name="Diesel", amount=1,probability =1},},}
...
makeRecipe{name="Lubricant",energy_required=4,category="Chemical_plant",ingredients={{type="fluid", name="Heavy_oil", amount=1},},results={{type="fluid", name="Lubricant", amount=1,probability =1},},}
...
makeRecipe{name="Hydrogen_chloride",energy_required=1.5,category="Chemical_plant",ingredients={{type="fluid", name="Chlorine", amount=1},{type="fluid", name="Hydrogen", amount=1},},results={{type="fluid", name="Hydrogen_chloride", amount=1,probability =1},},}
makeRecipe{name="Hydrochloric_acid",energy_required=1,category="Chemical_plant",ingredients={{type="fluid", name="Hydrogen_chloride", amount=1},{type="fluid", name="Water_distilled", amount=1},},results={{type="fluid", name="Hydrochloric_acid", amount=1,probability =1},},}
makeRecipe{name="Ferric_chloride_solution",energy_required=3,category="Chemical_plant",ingredients={{type="fluid", name="Hydrochloric_acid", amount=1},{type="item", name="Magnetite_concentrate", amount=1},},results={{type="fluid", name="Ferric_chloride_solution", amount=1,probability =1},},}
...
makeRecipe{name="Nitric_acid",energy_required=1,category="Chemical_plant",ingredients={{type="fluid", name="Water_distilled", amount=1},{type="fluid", name="Nitrogen_dioxide", amount=3},},results={{type="fluid", name="Nitric_acid", amount=2,probability =1},{type="item", name="Nitric_oxide", amount=1,probability =1},},}
...
makeRecipe{name="Uranyl_nitrate",energy_required=2.5,category="Chemical_plant",ingredients={{type="item", name="Yellowcake", amount=1},{type="fluid", name="Nitric_acid", amount=1},},results={{type="fluid", name="Uranyl_nitrate", amount=1,probability =1},},}
makeRecipe{name="ADU",energy_required=1,category="Chemical_plant",ingredients={{type="fluid", name="Ammonia", amount=1},{type="fluid", name="Uranyl_nitrate", amount=1},},results={{type="fluid", name="ADU", amount=1,probability =1},},}
...
makeRecipe{name="Germanium_tetrachloride",energy_required=4,category="Chemical_plant",ingredients={{type="item", name="Germanium_concentrate", amount=1},{type="fluid", name="Chlorine", amount=1},},results={{type="fluid", name="Germanium_tetrachloride", amount=1,probability =1},{type="fluid", name="Oxygen", amount=1,probability =1},},}
...
makeRecipe{name="Ammonia",energy_required=10,category="Chemical_plant",ingredients={{type="fluid", name="Hydrogen", amount=3},{type="fluid", name="Nitrogen", amount=1},},results={{type="fluid", name="Ammonia", amount=2,probability =1},},}
...
makeRecipe{name="Sulfur_dioxide",energy_required=3,category="Chemical_plant",ingredients={{type="item", name="Sulfur", amount=1},{type="fluid", name="Oxygen", amount=1},},results={{type="fluid", name="Sulfur_dioxide", amount=1,probability =1},},}
makeRecipe{name="Sulfuric_acid",energy_required=2,category="Chemical_plant",ingredients={{type="fluid", name="Sulfur_dioxide", amount=1},{type="fluid", name="Water", amount=1},},results={{type="fluid", name="Sulfuric_acid", amount=1,probability =1},},}
...
makeRecipe{name="Ethylbenzene",energy_required=2,category="Chemical_plant",ingredients={{type="fluid", name="Ethylene", amount=1},{type="fluid", name="Benzene", amount=1},},results={{type="fluid", name="Ethylbenzene", amount=1,probability =1},},}
makeRecipe{name="Styrene",energy_required=4,category="Chemical_plant",ingredients={{type="fluid", name="Ethylbenzene", amount=1},},results={{type="fluid", name="Styrene", amount=1,probability =1},{type="fluid", name="Hydrogen", amount=1,probability =1},},}
...
makeRecipe{name="Napalm",energy_required=2,category="Chemical_plant",ingredients={{type="item", name="Polystyrene", amount=1},{type="fluid", name="Diesel", amount=1},},results={{type="fluid", name="Napalm", amount=1,probability =1},},}
...
makeRecipe{name="Stainless_steel_billet",energy_required=1.5,category="Chemical_plant",ingredients={{type="fluid", name="Oxygen", amount=1},{type="fluid", name="Stainless_steel_mix_hot", amount=1},},results={{type="item", name="Stainless_steel_billet", amount=1,probability =1},},}
...
makeRecipe{name="Glycerol",energy_required=6,category="Chemical_plant",ingredients={{type="fluid", name="Seed_oil", amount=1},{type="item", name="Sodium_hydroxide", amount=3},{type="fluid", name="Water_distilled", amount=1},},results={{type="fluid", name="Glycerol", amount=1,probability =1},},}
makeRecipe{name="Toluene",energy_required=3,category="Chemical_plant",ingredients={{type="fluid", name="Light_oil", amount=1},},results={{type="fluid", name="Toluene", amount=1,probability =1},},}
makeRecipe{name="Sulfur_trioxide",energy_required=1,category="Chemical_plant",ingredients={{type="fluid", name="Sulfur_dioxide", amount=1},{type="fluid", name="Oxygen", amount=1},},results={{type="fluid", name="Sulfur_trioxide", amount=1,probability =1},},}
makeRecipe{name="Oleum",energy_required=1,category="Chemical_plant",ingredients={{type="fluid", name="Sulfur_trioxide", amount=1},{type="fluid", name="Sulfuric_acid", amount=1},},results={{type="fluid", name="Oleum", amount=1,probability =1},},}
makeRecipe{name="MNT",energy_required=1.5,category="Chemical_plant",ingredients={{type="fluid", name="Toluene", amount=1},{type="fluid", name="Nitric_sulfuric_acid_mixture", amount=1},},results={{type="fluid", name="MNT", amount=1,probability =1},},}
...
makeRecipe{name="Acrylonitrile",energy_required=8,category="Chemical_plant",ingredients={{type="fluid", name="Petroleum_gas", amount=2},{type="fluid", name="Ammonia", amount=2},{type="fluid", name="Oxygen", amount=3},},results={{type="fluid", name="Acrylonitrile", amount=2,probability =1},{type="fluid", name="Water", amount=6,probability =1},},}
...
makeRecipe{name="Trichlorosilane",energy_required=3,category="Chemical_plant",ingredients={{type="item", name="Silicon_metallurgical", amount=1},{type="fluid", name="Hydrochloric_acid", amount=3},},results={{type="fluid", name="Trichlorosilane", amount=1,probability =1},{type="fluid", name="Hydrogen", amount=1,probability =1},},}
...
makeRecipe{name="Trichlorosilane",energy_required=2,category="Chemical_plant",ingredients={{type="fluid", name="Silicon_tetrachloride", amount=1},{type="fluid", name="Hydrogen", amount=1},},results={{type="fluid", name="Trichlorosilane", amount=1,probability =1},{type="item", name="Hydrogen_chloride", amount=1,probability =1},},}
...
makeRecipe{name="Ammonia",energy_required=2,category="Chemical_plant",ingredients={{type="item", name="Ammonium_bifluoride", amount=1},{type="item", name="Magnesium_oxide", amount=1},},results={{type="fluid", name="Ammonia", amount=1,probability =1},{type="fluid", name="Water_distilled", amount=1,probability =1},{type="item", name="Magnesium_fluoride", amount=1,probability =1},},}
makeRecipe{name="Nitrogen",energy_required=4,category="Chemical_plant",ingredients={{type="item", name="Molecular sieve", amount=1},{type="item", name="Compressed_air", amount=10},},results={{type="fluid", name="Nitrogen", amount=7,probability =1},{type="fluid", name="Oxygen", amount=3,probability =1},},}
...
makeRecipe{name="Oxygen",energy_required=8,category="Electrolyzer",ingredients={{type="fluid", name="Water_distilled", amount=2},{type="fluid", name="Water", amount=2},},results={{type="fluid", name="Oxygen", amount=1,probability =1},{type="fluid", name="Hydrogen", amount=2,probability =1},},}
makeRecipe{name="Chlorine",energy_required=10,category="Electrolyzer",ingredients={{type="fluid", name="Water", amount=2},{type="item", name="Salt", amount=2},},results={{type="fluid", name="Chlorine", amount=1,probability =1},{type="fluid", name="Hydrogen", amount=1,probability =1},{type="item", name="Sodium_hydroxide", amount=2,probability =1},},}
...
makeRecipe{name="Uranium_hexafluoride",energy_required=3,category="Electrolyzer",ingredients={{type="fluid", name="Uranium_tetrafluoride", amount=1},{type="fluid", name="Hydrofluoric_acid", amount=2},},results={{type="fluid", name="Uranium_hexafluoride", amount=1,probability =1},},}
...
makeRecipe{name="Titanium_tetrachloride",energy_required=5,category="Electric_chemical_furnace",ingredients={{type="item", name="Coal_coke", amount=1},{type="item", name="Rutile_sand", amount=1},{type="fluid", name="Chlorine", amount=1},},results={{type="fluid", name="Titanium_tetrachloride", amount=1,probability =1},},}
...
makeRecipe{name="Stainless_steel_mix_hot",energy_required=40,category="Electric_arc_furnace",ingredients={{type="item", name="Nickel_billet", amount=1},{type="item", name="Ferrochrome", amount=1},{type="item", name="Steel_billet", amount=10},},results={{type="fluid", name="Stainless_steel_mix_hot", amount=10,probability =1},},}
...
makeRecipe{name="Coal_coke",energy_required=10,category="Distillery",ingredients={{type="item", name="Coal_dust", amount=10},},results={{type="item", name="Coal_coke", amount=7,probability =1},{type="item", name="Coal_tar", amount=1,probability =1},{type="fluid", name="Coal_gas", amount=1,probability =0.9},},}
makeRecipe{name="Bitumen",energy_required=5,category="Distillery",ingredients={{type="item", name="Coal_tar", amount=3},},results={{type="item", name="Bitumen", amount=3,probability =1},},}
makeRecipe{name="Water_distilled",energy_required=15,category="Distillery",ingredients={{type="fluid", name="Water", amount=10},},results={{type="fluid", name="Water_distilled", amount=9,probability =1},{type="item", name="Salt", amount=1,probability =0.05},},}
makeRecipe{name="Salt",energy_required=15,category="Distillery",ingredients={{type="fluid", name="Brine", amount=10},},results={{type="item", name="Salt", amount=1,probability =1},{type="item", name="Potassium_nitrate", amount=1,probability =0.3},{type="item", name="Lithium_chloride", amount=1,probability =0.01},{type="fluid", name="Water_distilled", amount=6,probability =1},},}
makeRecipe{name="Coal_coke",energy_required=11,category="Distillery",ingredients={{type="item", name="Coal_dust", amount=10},},results={{type="item", name="Coal_coke", amount=7,probability =1},{type="item", name="Coal_tar", amount=1,probability =1},{type="fluid", name="Coal_gas", amount=1,probability =1},{type="fluid", name="Ammonia", amount=1,probability =1},},}
makeRecipe{name="Ethylbenzene",energy_required=8,category="Distillery",ingredients={{type="item", name="Coal_tar", amount=3},},results={{type="fluid", name="Ethylbenzene", amount=1,probability =0.9},{type="fluid", name="Bitumi", amount=3,probability =1},},}
makeRecipe{name="Coal_coke",energy_required=12,category="Distillery",ingredients={{type="item", name="Coal_dust", amount=10},},results={{type="item", name="Coal_coke", amount=7,probability =1},{type="item", name="Coal_tar", amount=1,probability =1},{type="fluid", name="Coal_gas", amount=1,probability =1},{type="fluid", name="Ammonia", amount=1,probability =1},{type="fluid", name="Benzene", amount=0.1,probability =0.9},},}
makeRecipe{name="Salt",energy_required=15,category="Distillery",ingredients={{type="fluid", name="Brine", amount=10},},results={{type="item", name="Salt", amount=1,probability =0.5},{type="item", name="Potassium_nitrate", amount=1,probability =0.3},{type="fluid", name="Water_distilled", amount=6,probability =1},},}
makeRecipe{name="Petroleum_gas",energy_required=10,category="Refinery",ingredients={{type="fluid", name="Crude_oil", amount=10},},results={{type="fluid", name="Petroleum_gas", amount=4,probability =1},{type="fluid", name="Light_oil", amount=4,probability =1},{type="fluid", name="Heavy_oil", amount=2,probability =1},},}
makeRecipe{name="Syngas",energy_required=3,category="Cracking_Plant",ingredients={{type="fluid", name="Coal_gas", amount=1},{type="fluid", name="Water_distilled", amount=1},},results={{type="fluid", name="Syngas", amount=1,probability =1},{type="fluid", name="Toluene", amount=1,probability =0.1},},}
makeRecipe{name="Ethylene",energy_required=3,category="Cracking_Plant",ingredients={{type="fluid", name="Benzene", amount=1},{type="fluid", name="Water_distilled", amount=1},},results={{type="fluid", name="Ethylene", amount=1,probability =1},},}
makeRecipe{name="Ethylene",energy_required=2,category="Cracking_Plant",ingredients={{type="fluid", name="Petroleum_gas", amount=1},{type="fluid", name="Water_distilled", amount=1},},results={{type="fluid", name="Ethylene", amount=1,probability =1},{type="fluid", name="Toluene", amount=1,probability =0.1},},}
makeRecipe{name="Petroleum_gas",energy_required=2,category="Cracking_Plant",ingredients={{type="fluid", name="Light_oil", amount=1},{type="fluid", name="Water_distilled", amount=1},},results={{type="fluid", name="Petroleum_gas", amount=1.5,probability =1},},}
makeRecipe{name="Butadiene",energy_required=3,category="Cracking_Plant",ingredients={{type="fluid", name="Light_oil", amount=1},{type="fluid", name="Water_distilled", amount=1},},results={{type="fluid", name="Butadiene", amount=1,probability =1},{type="fluid", name="Hydrogen", amount=1,probability =1},},}
makeRecipe{name="Light_oil",energy_required=3,category="Cracking_Plant",ingredients={{type="fluid", name="Heavy_oil", amount=1},{type="fluid", name="Water_distilled", amount=1},},results={{type="fluid", name="Light_oil", amount=1.5,probability =1},},}
makeRecipe{name="Hydrogen",energy_required=2,category="Cracking_Plant",ingredients={{type="fluid", name="Petroleum_gas", amount=1},{type="fluid", name="Water_distilled", amount=1},},results={{type="fluid", name="Hydrogen", amount=10,probability =1},},}
...
makeRecipe{name="Syngas",energy_required=2,category="Cracking_Plant",ingredients={{type="item", name="CO", amount=1},{type="fluid", name="Hydrogen", amount=3},},results={{type="fluid", name="Syngas", amount=1,probability =1},},}
...
makeRecipe{name="Nitrogen",energy_required=2,category="Cryogenic_distillation_plant",ingredients={{type="fluid", name="Air", amount=1},},results={{type="fluid", name="Nitrogen", amount=1,probability =0.78},{type="fluid", name="Oxygen", amount=1,probability =0.21},{type="fluid", name="Argon", amount=1,probability =0.01},},}
