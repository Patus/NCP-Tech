...
data:extend(
{
    ...
    fast_replaceable_group = "Rotary_kiln",
    animation =
    {
    ...
    crafting_categories = {"Rotary_kiln"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Ore_washing",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
  ...
  },
  {
    ...
    crafting_categories = {"Chemical_plant"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Chemical_furnace",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
    ...
    crafting_categories = {"Chemical_furnace"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Blast_furnace",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
    ...
    crafting_categories = {"Blast_furnace"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    crafting_categories = {"Nuclear_fuel_processing_plant"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Rolling_machine",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
    ...
    crafting_categories = {"Rolling_machine"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    icon = "__base__/graphics/icons/assembling-machine-2.png",
    flags = {"placeable-neutral", "placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "Shifter"},
    max_health = 250,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    resistances =
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Shifter",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
  ...
  },
  {
    ...
    icon = "__base__/graphics/icons/assembling-machine-2.png",
    flags = {"placeable-neutral", "placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "Silicon_crucible"},
    max_health = 250,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    resistances =
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Silicon_crucible",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
    ...
    crafting_categories = {"Silicon_crucible"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    crafting_categories = {"Cracking_plant"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    icon = "__base__/graphics/icons/assembling-machine-2.png",
    flags = {"placeable-neutral", "placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "Dry_distillation"},
    max_health = 250,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    resistances =
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Dry_distillation",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
    ...
    crafting_categories = {"Dry_distillation"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Electric_arc_furnace",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
    ...
    crafting_categories = {"Electric_arc_furnace"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Vacuum_oxygen_decarburization",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
    ...
    crafting_categories = {"Vacuum_oxygen_decarburization"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "cotton_farm",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
  ...
  },
  {
    ...
    icon = "__base__/graphics/icons/assembling-machine-2.png",
    flags = {"placeable-neutral", "placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "Alloy_furnace"},
    max_health = 250,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    resistances =
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Alloy_furnace",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
    ...
    crafting_categories = {"Alloy_furnace"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    icon = "__base__/graphics/icons/assembling-machine-2.png",
    flags = {"placeable-neutral", "placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "Lithium_extractor"},
    max_health = 250,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    resistances =
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Lithium_extractor",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
    ...
    crafting_categories = {"Lithium_extractor"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Electronics_assembly_machine",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
    ...
    crafting_categories = {"Electronics_assembly_machine"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    icon = "__base__/graphics/icons/assembling-machine-2.png",
    flags = {"placeable-neutral", "placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "Anode_furnace"},
    max_health = 250,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    resistances =
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Anode_furnace",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
    ...
    crafting_categories = {"Anode_furnace"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Flash_furnace",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
    ...
    crafting_categories = {"Flash_furnace"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "TSL_furnace",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
    ...
    crafting_categories = {"TSL_furnace"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Extruder",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
  ...
  },
  {
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Milling_machine",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
    ...
    crafting_categories = {"Milling_machine"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    crafting_categories = {"Assembling_machine"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
    selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    fast_replaceable_group = "Electric_flash_furnace",
    animation =
    {
      filename = "__base__/graphics/entity/assembling-machine-2/assembling-machine-2.png",
      priority = "high",
    ...
    crafting_categories = {"Electric_flash_furnace"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
